...
type DBMetricDatapoints struct {
	Identifier MetricKey           `json:"identifier" bson:"identifier"`
	Datapoints []DBMetricDatapoint `json:"datapoints" bson:"datapoints"`
}
...
type DBServiceInstanceMetrics struct {
	...
	Metrics        []DBMetricDatapoints `json:"metrics" bson:"metrics"`
}

type DBHostMetrics struct {
	Host                   string                     `json:"host" bson:"host"`
	SystemMetrics          []DBMetricDatapoints       `json:"system_metrics" bson:"system_metrics"`
