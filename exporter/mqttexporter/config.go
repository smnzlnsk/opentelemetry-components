package mqttexporter // import github.com/smnzlnsk/opentelemetry-components/exporter/mqttexporter
...
func (cfg *Config) Validate() error {
	...
	// broker.host
	if os.Getenv("MQTTEXPORTER_MONITORING_BROKER_HOST") != "" {
		cfg.Broker.Host = os.Getenv("MQTTEXPORTER_MONITORING_BROKER_HOST")
	}
	...
	// broker.port
	if os.Getenv("MQTTEXPORTER_MONITORING_BROKER_PORT") != "" {
		if v, err := strconv.Atoi(os.Getenv("MQTTEXPORTER_MONITORING_BROKER_PORT")); err != nil {
			cfg.Broker.Port = v
		}
	}
